  ...
  return (
    <nav className="flex text-white items-center h-24 max-w-[1240px] mx-auto px-4 justify-between">
      ...
      <ul className="hidden md:flex items-center">
        <li className="p-4">
          <img src="https://imgs.search.brave.com/wAQUKCmksVgYZ-RJkprHGp5ouEi-PqcEZZGZQvjRxDk/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzL2UyLzQz/LzIyL2UyNDMyMjc2/YzlhMDFlNGI4OTEz/ZTEzYzAxYjliMWY3/LmpwZw" alt="About" className="h-8 w-auto" />
        </li>
        <li className="p-4">
